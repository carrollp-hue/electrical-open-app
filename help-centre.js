(() => {
  ...
  help = function () {
    ...
    const administratorGuide = state.isAdmin
      ? `<section class="section"><h2>App administrator resources</h2>${guideCard('App administrator quick guide', 'A concise handover guide covering access, hosting, backups and safe administration.', './help/App-Administrator-Quick-Guide.pdf', 'Electrical-Open-App-Administrator-Quick-Guide.pdf')}${guideCard('Administrator access checklist', 'A quick reminder of how to give a signed-in member administrator access.', './help/Administrator-Access-Checklist.pdf', 'Electrical-Open-Administrator-Access-Checklist.pdf')}${guideCard('Member email address changes', 'Supabase steps for changing a member email without affecting their player record, handicap or results.', './help/Member-Email-Address-Changes.html', 'Electrical-Open-Member-Email-Address-Changes.html')}</section>`
      : '';
