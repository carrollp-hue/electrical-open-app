-- Restore Dunstable Downs 9 August 2026 as qualifying app data.
-- Run after any legacy Dunstable import. Workbook values remain in
-- historic_display_differential for audit only.
