-- Restore the calculated score differentials for Dunstable Downs, 9 August 2026.
-- The original workbook values remain in historic_display_differential for audit only.
-- Non Returns follow the society rule: fixture-entry handicap index + 5.0.
...
set adjusted_gross_score = ht.adjusted_gross,
    score_differential = round(
      ((ht.adjusted_gross - cs.course_rating
